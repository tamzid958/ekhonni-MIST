    ...
    return (
        <>
            ...
            <div className="fixed inset-0 z-10 bg-black bg-opacity-20 backdrop-blur-[1px] flex justify-center items-center" id="backgroundBlur" onClick={(e) => {handleModalCloseOnBgClick(e)}}>
                <div className="w-[40%] h-[75%] flex flex-col">
                    ...
                    <div className="w-full h-full border border-neutral-700 bg-white shadow-lg shadow-slate-500 flex justify-center items-center rounded-lg">
                        <div className="w-[90%] h-[90%] flex flex-col justify-start items-center">
                            <div className="w-full h-[25%] border border-neutral-300 overflow-hidden flex justify-start items-center bg-slate-100 shadow-lg shadow-slate-300 rounded-lg transition ease-in-out duration-500 hover:scale-[102%]">
                            ...
                            <div className="w-full h-[75%] flex flex-row justify-center items-center">
                                <div className="w-2/5 h-full flex flex-col justify-center items-start ">
                                    <div className="w-5/6 h-1/4 border border-neutral-300 my-[5%] flex justify-center items-center bg-slate-100 shadow-lg shadow-slate-300 rounded-lg transition ease-in-out duration-500 hover:scale-[102%]">
                                        <p className="text-lg font-medium text-black text-nowrap truncate">Max Bid = Tk {maxBid}</p>
                                    </div>
                                    <div  className="w-5/6 h-2/3 border border-neutral-300 flex flex-col justify-center items-center  bg-slate-100 shadow-lg shadow-slate-300 rounded-lg transition ease-in-out duration-500 hover:scale-[102%]">
                                ...
                                <div className="w-3/5 h-full flex justify-end items-start">
