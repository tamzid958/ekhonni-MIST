    ...
    return (
        <label htmlFor="toggleButton" className="flex bg-slate-300 cursor-pointer relative w-36 h-12 rounded-md">
            ...
            <span
                ...
                {bidIsActive && (<p className="absolute left-2.5 top-2.5 text-[0.85rem] text-white ">Enabled</p>)}
                {!bidIsActive && (<p className="absolute left-2 top-2.5 text-[0.85rem] text-white">Disabled</p>)}
            </span>
        </label>
    )
}
