    ...
    return ( <>
        {visibility &&
            <ul className="w-full mt-[5%] rounded-lg ">
                <li className="w-full p-2 list-none rounded-lg bg-slate-100 border border-neutral-300 shadow-lg shadow-slate-300 group transition ease-in-out duration-500 hover:scale-[103%]">
                    ...
                    <div className="w-full max-h-0 overflow-hidden peer-checked:max-h-72 hover:overflow-y-scroll transition-all ease-in-out duration-1000">
