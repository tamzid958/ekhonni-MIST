...
const BidderList = ({visibility , bidders , view , finalBuyerID}) => {
    ...
    const timeoutID = setTimeout(() => {setExpandList(true)} ,50);
        ...
        {visibility &&
            <ul className="w-full mt-[2%] rounded-lg ">
                <li className="w-full p-2 flex flex-col items-center list-none rounded-lg bg-slate-100 border border-neutral-300 shadow-lg shadow-slate-300 group transition ease-in-out duration-500 hover:scale-[100.5%]">
                    ...
                    <label htmlFor={"first"}
                           className="w-full flex items-center mb-2 p-1 text-xl before:mr-3 before:font-semibold before:text-lg rounded-lg">Bidder List
                        </label>
            ...
            {!visibility &&
                <div className="w-full flex ">
                    <div className="w-full p-4 mt-[2%] list-none rounded-lg bg-red-200 shadow-lg shadow-slate-300 cursor-default">
