...
const BidderList = ({visibility, bidders, view, finalBuyerID}) => {
    ...
    return (<>
            {visibility &&
                <ul className="w-full mt-[2%] rounded-lg ">
                    <li className="w-full p-2 flex flex-col items-center list-none rounded-lg bg-slate-100 border border-neutral-300 shadow-lg shadow-slate-300 group transition ease-in-out duration-500 hover:scale-[100.5%]">
                        ...
                        <label htmlFor={"first"}
                               className="w-full flex items-center mb-2 p-1 text-xl cursor-pointer before:mr-3 before:font-semibold before:text-lg rounded-lg">Bidder
                            List
                        </label>
                        <div
                            className="w-full overflow-hidden max-h-72 hover:overflow-y-scroll transition-all ease-in-out duration-1000">
            ...
            {!visibility &&
                <div
                    className="w-full p-2 mt-[5%] list-none rounded-lg bg-red-200 shadow-lg shadow-slate-300 transition ease-in-out duration-500 hover:scale-105 cursor-pointer">
