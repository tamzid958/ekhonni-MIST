    ...
    return (
        <>
            ...
            <div
                ...
                <div className="w-[50%] h-[75%] flex flex-col">
                    <button
                    ...
                    <div
                        ...
                        <div className="w-[90%] h-[90%] flex flex-col justify-start items-center">
                            <div
                                className="w-full h-[25%] border border-neutral-300 overflow-hidden flex justify-start items-center bg-slate-100 shadow-lg shadow-slate-300 rounded-lg transition ease-in-out duration-500 hover:scale-105">
                                <p className="p-3 text-2xl font-semibold text-black text-wrap text-ellipsis "> Product
                                    Name</p>
                            </div>
                            <div className="w-full h-[75%] flex flex-row justify-center items-center">
                                <div className="w-1/2 h-full  flex flex-col justify-center items-start ">
                                    <div
                                        className="w-5/6 h-1/4 border border-neutral-300 my-[5%] flex justify-center items-center bg-slate-100 shadow-lg shadow-slate-300 rounded-lg transition ease-in-out duration-500 hover:scale-105">
                                        <p className="text-md font-medium text-black text-nowrap truncate">Max Bid =
                                            Tk {maxBid}</p>
                                    </div>
                                    <form onSubmit={handleEnterBid}
                                          className="w-5/6 h-2/3 border border-neutral-300 flex flex-col justify-center items-center  bg-slate-100 shadow-lg shadow-slate-300 rounded-lg transition ease-in-out duration-500 hover:scale-105">
                                        <label htmlFor="bidAmount">Enter Bid Amount</label>
                                        <input
                                            className="w-[90%] h-[25%] my-2 mb-3 pl-2  bg-slate-50 shadow-lg shadow-slate-300 focus:outline-none rounded-lg transition ease-in-out duration-500 focus:scale-105"
                                            placeholder={maxBid + 1} type={"number"} value={bid} onChange={(e) => {
